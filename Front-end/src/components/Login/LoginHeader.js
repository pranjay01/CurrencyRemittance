...
import { showSignupModal } from '../../constants/action-types';
        ...
        <nav>
          <div className="locked-home-lg-margins d-block pt-xsm px-std">
            <div id="loginheder" className="row justify-content-between align-items-baseline">
              ...
              <div className="container-menu-mask d-lg-none" />
              <div className="d-flex justify-content-lg-end align-items-center order-lg-last">
                <div className="locked-home-sign-in">
                  <a
                    onClick={this.showSignup}
                    href="#"
                    className="track-click gd-btn-locked-transparent susiLink sign-in strong nowrap"
                    target="_top"
                    data-ga-lbl="Sign In"
                  >
                    {' '}
                ...
                <div className="locked-home-post-jobs strong d-none d-lg-block">
                  <a
                    href="/post-job"
                    className="track-click nowrap"
                    target="_top"
                    data-track-cmpgn="home"
                    data-track-source="site-header-locked-b2c"
                    data-track-type="src"
                    data-ga-lbl="Post Jobs Free (Desktop)"
                  >
                    {' '}
                  </a>
                </div>
